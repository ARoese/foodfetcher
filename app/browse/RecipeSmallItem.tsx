...
type args = {recipe : Recipe, className?: string, onClick?: () => void | null}
function RecipeSmallItem({recipe, className = "", onClick = null} : args) {
    ...
    return ( 
        ...
        <div className={className}>
            <a href={`/recipe/${recipe.id}`} onClick={onAnchor}>
